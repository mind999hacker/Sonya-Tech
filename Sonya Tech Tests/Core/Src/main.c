...
/* USER CODE BEGIN Header_HeaterFunction */
/**
* @brief Function implementing the Heater thread.
* @param argument: Not used
* @retval None
*/
...
/* USER CODE BEGIN Header_CoolerFunction */
/**
* @brief Function implementing the Cooler thread.
* @param argument: Not used
* @retval None
*/
