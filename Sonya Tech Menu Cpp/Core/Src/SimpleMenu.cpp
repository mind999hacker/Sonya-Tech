...
SimpleMenu::SimpleMenu(std::string _name,int *_value) //Value menu
{
 name = _name;
 value = _value;
}
...
SimpleMenu::SimpleMenu(std::string _name, bool (*_ListCallBack)(int index), SimpleMenu *_subListmenus) //List menu with function
{
  name = _name;
  subListmenus = _subListmenus;
  ListCallBack = _ListCallBack;
...
SimpleMenu::SimpleMenu(std::string _name, bool (*_ListCallBack)(int index), void (*_CallBack)()) //List menu with function
{
  name = _name;
  CallBack = _CallBack;
  ListCallBack = _ListCallBack;
